                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="display: flex; justify-content: flex-end; padding-bottom: 10px">
                                        <a class="btn btn-primary" href="{{ route('admin-teams-add') }}"><i class="fa fa-plus"> Add Team</i></a>
                                    </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered dataTable table-sm"
                                        ...
                                        <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0"  style="width: 34.438px;">
                                                Id
                                            </th>
                                            <th class="sorting" tabindex="0" style="width: 204.156px;">
                                                Name
                                            </th>
                                            <th class="sorting" tabindex="0"  style="width: 91.7083px;">
                                                Supervisor
                                            </th>
                                            <th class="sorting" tabindex="0"  style="width: 91.7083px;">
                                                Members
