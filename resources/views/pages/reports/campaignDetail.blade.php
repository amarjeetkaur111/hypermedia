                    ...
                    <table style="width: 100%; border-spacing: 1px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  style="width: 80%;vertical-align: middle;" class="data_col">{{$bucket['assets']['name']}}</td>
                            <tr>
                            <tr>
                                <td  style="width: 20%;vertical-align: middle; background-color: #212529; color: #DEE2E6;text-align: center;">Asset Type</td>
                                <td  style="width: 80%;vertical-align: middle;" class="data_col">{{$bucket['assets']['type']}}</td>
                            <tr>
                        </tbody>
                    </table>
                </td>
